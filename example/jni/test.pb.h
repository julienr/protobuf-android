...
class Test : public ::google::protobuf::Message {
 public:
  ...
  // repeated int32 v1 = 1;
  inline int v1_size() const;
  inline void clear_v1();
  static const int kV1FieldNumber = 1;
  inline ::google::protobuf::int32 v1(int index) const;
  inline void set_v1(int index, ::google::protobuf::int32 value);
  inline void add_v1(::google::protobuf::int32 value);
